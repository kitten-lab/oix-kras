...
$ROUTE__LINE = ROUTE('d', $SHADOW_PROD_TOGGLE);
 ...
 $ECHO_ROUTE = $ROUTE__LINE . 'trackerKEEPER/' . $simpleyear . '/';
  ...
  function buildCHEST($site, $cUID,$POST__TIMBER_TOPIC,$POST__TIMBER_LEAF,$POST__PV,$TOOL_LOC,$TOOL_NAME, $unix, $event_time, $tUID,$timezone){
    return [
            "CUID" => $cUID, 
  ...
  $CHEST_THINGS[$cUID] = buildCHEST($site, $cUID,$POST__TIMBER_TOPIC,$POST__TIMBER_LEAF,$POST__PV,$TOOL_LOC,$TOOL_NAME, $unix, $event_time, $tUID,$timezone);
  $ECHO_CHEST_THINGS[$cUID] = buildCHEST($site, $cUID,$POST__TIMBER_TOPIC,$POST__TIMBER_LEAF,$POST__PV,$TOOL_LOC,$TOOL_NAME, $unix, $event_time, $tUID,$timezone);
