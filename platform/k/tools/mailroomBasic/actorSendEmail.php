...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // CHANGE PER TOOL //
  $chestNOTE = $_POST['log_leafTopic']; 
  $chestCONTENT = $_POST['log_leafText']; 
  $betACTION = "MAIL SENT: mailroomBASIC";
  $reportHEAD = "mailroomBasic|actorAdd";
...
$tpsDATA = buildTPS($unix,$ms,$tzone);
   ...
   $dir =  $GLOBALS['sonar'] . 'd/mailRoom/' . $_POST['betSys'];
...
if (!is_dir($dir)) {
  ...
  $entries[$chestUID] = [
    ...
    "to.DOM" => $_POST['to_betDom'],
    "to.MOD" => $_POST['to_betMod'],
    "to.SYS" => $_POST['to_betSys'],
    "from.DOM" => $_POST['from_betDom'],
    "from.MOD" => $_POST['from_betMod'],
    "from.SYS" => $_POST['from_betSys'],
